...
WebUI.click(findTestObject('Object Repository/Page_Dashboard Page - Bayeue/i_Accounts_v-icon notranslate mdi mdi-face-_b565dc'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard Page - Bayeue/div_Logout'))
